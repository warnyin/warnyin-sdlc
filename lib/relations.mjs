...
// Ready = waiting on nothing. Ordered by how many changes it frees, then by
...
export function shipImpact(analysis, changeId) {
  ...
  for (const node of analysis.nodes) {
    ...
    (remaining.length === 0 ? freed : waiting).push({ id: node.id, remaining });
  }
